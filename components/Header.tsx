...
export default function Header() {
  ...
  const BlogLogo = () => (
    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
      ...
      <rect x="25" y="15" width="50" height="70" rx="5" fill="url(#blogGradient)" stroke="white" strokeWidth="2"/>
      <rect x="30" y="25" width="20" height="3" rx="1.5" fill="white"/>
      <rect x="30" y="32" width="35" height="2" rx="1" fill="white" opacity="0.9"/>
      <rect x="30" y="38" width="30" height="2" rx="1" fill="white" opacity="0.9"/>
      <rect x="30" y="44" width="35" height="2" rx="1" fill="white" opacity="0.9"/>
      <rect x="30" y="50" width="25" height="2" rx="1" fill="white" opacity="0.9"/>
      ...
      <header className="bg-gray-900/95 backdrop-blur-md border-b border-gray-700/50 px-4 lg:px-8 py-4 sticky top-0 z-50">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <div 
            ...
            onClick={() => alert('Welcome to BlogSphere!')}
          >
            <BlogLogo />
              ...
              <div className="relative">
                ...
                {showPopover && (
                  <div className="absolute top-12 right-0 w-48 bg-gray-800 border border-gray-600 rounded-lg shadow-xl py-2 transform transition-all duration-200">
                    ...
                    <Link href="/myblogs" className="w-full px-4 py-3 text-left text-white hover:bg-gray-700 transition-colors duration-200 flex items-center gap-3">
